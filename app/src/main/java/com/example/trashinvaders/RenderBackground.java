...
public class RenderBackground implements EntityBase{
    ...
    private Bitmap scaledbmp = null; // will be a scaled version of the
    //bmp based on the Screenwidth and height
    ...
    public void Update(float _dt){
        ...
        xPos -= _dt * 500;  // 500 is just a variable number ..
        // can be edited.
        // It is to deal with speed = how fast the screen scrolls
